...
curl -fL -o $HOME/.githooks/pre-commit https://raw.githubusercontent.com/kim-lindhard/kim-lindhard-homepage/master/cool-stuff/are-you-sure-you-want-to-commit-to-main.sh
